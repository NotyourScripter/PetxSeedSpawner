...
holdingLabel.Position = UDim2.new(0.5, -115, 0, 185)
...
saveBtn.Position = UDim2.new(0.5, -90, 0, 260)
saveBtn.BackgroundColor3 = Color3.fromRGB(0, 50, 100)
saveBtn.Text = "Save Pet"
saveBtn.TextSize = 20
...
footer.Position = UDim2.new(0, 5, 1, -55)
...
saveBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
	...
	for i = 1, 9 do
		...
		saveBtn.Text = "Saving" .. string.rep(".", dotCount)
	end
